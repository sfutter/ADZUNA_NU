...
# ensure that variables are numeric for the centering to work as input to neural net
...
pr.nn <- compute(nn,test_[,1:colmax]) # just has to be less than number of cols in test_. can write var store to avoid manual entry
